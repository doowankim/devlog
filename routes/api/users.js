...
// @route GET localhost:4000/users/current
...
// @route POST localhost:4000/users/signup
// @desc user register
// @access Public
...
// @route POST localhost:4000/users/login
// @desc user login
// @access Public
...
// @route GET localhost:4000/users/total
// @desc total user
// @access Private
...
// @route DELETE localhost:4000/users/delete/:userId
// @desc delete user
// @access Private
